...
<div>
    <section data-name="title">
        ...
        <p>This Privacy Policy governs the manner in which Pixelstairs collects, uses, maintains and discloses information collected from users (each, a "User") of the www.Pixelstairs.com website ("Site"). This privacy policy applies to the Site and all products and services offered by <strong>Pixelstairs</strong>.</p>
    </section>

    <section>
        <h3 data-name="subtitle">Personal identification information</h3>
    ...
    <section>
        <h3 data-name="subtitle">Non-personal identification information</h3>
        <div data-name="content">
    ...
    <section>
        <h3 data-name="subtitle">Purpose of use</h3>
        <div data-name="content">
            <p>The information we collect may be used for the following:</p>
            <ol>
                <li>Enhance better service</li>
                <li>Personalize user experience</li>
                <li>Improve customer service</li>
                <li>To prevent the violation usage of terms and services</li>
                <li>In order to gather statistical data of users.</li>
            </ol>
        </div>
    </section>

    <section>
        <h3 data-name="subtitle">Information protected</h3>
        <div data-name="content">
            <p>We adopt appropriate data collection, storage and processing practices and security measures to protect against unauthorized access, alteration, disclosure or destruction of your personal information, username, password, transaction information and data stored on our Site.</p>
            <p>All data exchange between the Site and its Users happens over a SSL secured communication channel and is encrypted and protected with digital signatures.</p>
        </div>
    </section>

    <section>
        <h3 data-name="subtitle">Cookies</h3>
        <div data-name="content">
    ...
    <section>
        <h3 data-name="subtitle">Google Analytics</h3>
        <div data-name="content">
            ...
            <p>We can not interfere or be responsible for any user data stored and managed in Google's databases as we use Google Analytics.</p>
        </div>
    </section>

    <section>
        <h3 data-name="subtitle">Your consent</h3>
        <div data-name="content">
    ...
    <section>
        <h3 data-name="subtitle">Changes to privacy policy</h3>
        <div data-name="content">
            <p>www.pixelstairs.com has the discretion to update this privacy policy at any time. When we do, we encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
        </div>
    </section>
